...
RIFE::RIFE(int gpuid, std::string model_path_dir, int scale, bool _tta_mode, 
            bool _tta_temporal_mode, bool _uhd_mode, int _num_threads, 
...
int RIFE::load(const std::string& modeldir)
{
    ...
    flownet.register_custom_layer("rife.Warp", RifeWarp_layer_creator);
    contextnet.register_custom_layer("rife.Warp", RifeWarp_layer_creator);
    fusionnet.register_custom_layer("rife.Warp", RifeWarp_layer_creator);
